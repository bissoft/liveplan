            ...
            if ($request->type == 3) {
                ...
                if ($request->signups == 0) {
                    ...
                    $data = [
                        $request->signup_month0, $request->signup_month1, $request->signup_month2, $request->signup_month3,
                        $request->signup_month4, $request->signup_month5, $request->signup_month6, $request->signup_month7, $request->signup_month8,
                        $request->signup_month9, $request->signup_month10, $request->signup_month11, $request->signup_month_total,
                        $request->signup_year2, $request->signup_year3, $request->signup_year4, $request->signup_year5
                    ];
                    $revenue->signups_amount = json_encode($data);
                }
                if ($request->up_front == 0) {
                    ...
                    $data1 = [
                        $request->up_front_month0, $request->up_front_month1, $request->up_front_month2, $request->up_front_month3,
                        $request->up_front_month4, $request->up_front_month5, $request->up_front_month6, $request->up_front_month7, $request->up_front_month8,
                        $request->up_front_month9, $request->up_front_month10, $request->up_front_month11, $request->up_front_year1,
                        $request->up_front_year2, $request->up_front_year3, $request->up_front_year4, $request->up_front_year5
                    ];
                    $revenue->up_front_amount = json_encode($data1);
                }
                if ($request->recurring_charge == 0) {
                    ...
                    $data = [
                        $request->recurring_month0, $request->recurring_month1, $request->recurring_month2, $request->recurring_month3,
                        $request->recurring_month4, $request->recurring_month5, $request->recurring_month6, $request->recurring_month7,
                        $request->recurring_month8, $request->recurring_month9, $request->recurring_month10, $request->recurring_month11,
                        $request->recurring_year1, $request->recurring_year2, $request->recurring_year3, $request->recurring_year4, $request->recurring_year5
                    ];
                    $revenue->recurring_amount = json_encode($data);
                }
                if ($request->churn_rate == 0) {
                    ...
                    $data = [
                        $request->churn_month0, $request->churn_month1, $request->churn_month2, $request->churn_month3,
                        $request->churn_month4, $request->churn_month5, $request->churn_month6, $request->churn_month7,
                        $request->churn_month8, $request->churn_month9, $request->churn_month10, $request->churn_month11,
                        $request->churn_year1, $request->churn_year2, $request->churn_year3, $request->churn_year4, $request->churn_year5
                    ];
                    $revenue->churn_amount = json_encode($data);
                }
            }
            if ($request->type == 4) {
                ...
                if ($request->only_revenue == 0) {
                    ...
                    $data = [
                        $request->revenue_month0, $request->revenue_month1, $request->revenue_month2, $request->revenue_month3,
                        $request->revenue_month4, $request->revenue_month5, $request->revenue_month6, $request->revenue_month7, $request->revenue_month8,
                        $request->revenue_month9, $request->revenue_month10, $request->revenue_month11, $request->revenue_month_total,
                        $request->revenue_year2, $request->revenue_year3, $request->revenue_year4, $request->revenue_year5
                    ];
                    $revenue->only_revenue_amount = json_encode($data);
                }
            }
