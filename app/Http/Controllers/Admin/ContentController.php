...
class ContentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $content->sub_title = $request->title;
        $content->key = $request->key;
        $content->description = $request->description;
        $content->save();
        return redirect('admin/content')->with('success','Website Content has created!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $content->description = $request->description;
        $content->update();
        return redirect('admin/content')->with('success','Website Content has updated!');
    }
