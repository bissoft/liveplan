...
class HomeController
{
    ...
    public function changeOrganization($id = null)
    {
        auth()->user()->update(['xero_organization_id' => $id]);
    ...
    public function contacts($type = null)
    {
        ...
        $contacts = $q->paginate(10);

        return view('admin.users.contacts', compact('contacts', 'type'));
    }
}
