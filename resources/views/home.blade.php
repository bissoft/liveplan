			...
			<div class="container-fluid">
							...
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										...
										<span class="fs-14">Number of business clients</span>
									</div>
							...
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										...
										<span class="fs-14">Outstanding support tickets</span>
									</div>
									<svg class="primary-icon" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M11.9999 1.5H5.99994C3.51466 1.5 1.49994 3.51472 1.49994 6V29.8125C1.49994 32.2977 3.51466 34.3125 5.99994 34.3125H11.9999C14.4852 34.3125 16.4999 32.2977 16.4999 29.8125V6C16.4999 3.51472 14.4852 1.5 11.9999 1.5Z" fill="#FF6600"/>
										<path d="M30 1.5H24C21.5147 1.5 19.5 3.51472 19.5 6V12C19.5 14.4853 21.5147 16.5 24 16.5H30C32.4853 16.5 34.5 14.4853 34.5 12V6C34.5 3.51472 32.4853 1.5 30 1.5Z" fill="#FF6600"/>
										<path d="M30 19.5H24C21.5147 19.5 19.5 21.5147 19.5 24V30C19.5 32.4853 21.5147 34.5 24 34.5H30C32.4853 34.5 34.5 32.4853 34.5 30V24C34.5 21.5147 32.4853 19.5 30 19.5Z" fill="#FF6600"/>
									</svg>
								</div>
							</div>
						</div>
				...
				<div class="row">
						...
						<div class="card">
							<div class="card-header d-block border-0 pb-0">
								<div class="d-flex justify-content-between pb-3">
									<h4 class="mb-0 text-black fs-20">Revenue per month</h4>
									<div class="dropdown">
										<a href="javascript:void(0)" data-toggle="dropdown" aria-expanded="false">
											<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="#FF6600" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
												<path d="M12 6C12.5523 6 13 5.55228 13 5C13 4.44772 12.5523 4 12 4C11.4477 4 11 4.44772 11 5C11 5.55228 11.4477 6 12 6Z" stroke="#FF6600" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
												<path d="M12 20C12.5523 20 13 19.5523 13 19C13 18.4477 12.5523 18 12 18C11.4477 18 11 18.4477 11 19C11 19.5523 11.4477 20 12 20Z" stroke="#FF6600" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
											</svg>
										</a>
								...
								<div class="d-flex align-items-center">
									...
									<div>
										<svg class="mr-2" width="27" height="14" viewBox="0 0 27 14" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M0 13.435L13.435 0L26.8701 13.435H0Z" fill="#FF6600"></path>
										</svg>
					...
					<div class="col-xl-3 col-xxl-6 col-sm-6">
						<div class="card">	
							<div class="card-header border-0 pb-0">
								<h4 class="fs-20 mb-0 text-black">Number of clients month on month</h4>
								<div class="dropdown">
									<a href="javascript:void(0)" data-toggle="dropdown" aria-expanded="false">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="col-xl-3 col-xxl-6 col-sm-6">
						<div class="card">	
							<div class="card-header border-0 pb-0">
								<h4 class="fs-20 mb-0 text-black">Customer satisfaction - rating from TrustPilot</h4>
								<div class="dropdown">
									<a href="javascript:void(0)" data-toggle="dropdown" aria-expanded="false">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="#575757" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
							...
							<div class="col-sm-6">
								<div class="card">	
									<div class="card-header border-0">
										<h4 class="fs-16 text-black font-w500">Prospect business clients</h4>
										<div class="d-flex align-items-center">
								...
								<div class="card">
									<div class="card-body text-center d-flex align-items-center justify-content-between">
										<div class="d-inline-block position-relative donut-chart-sale">
											<span class="donut1" data-peity='{ "fill": ["rgb(255, 102, 0, 1)", "rgba(241, 241, 241,1)"],   "innerRadius": 33, "radius": 10}'>3/8</span>
											<small class="text-dark">29%</small>
										</div>
										<div>
											<h2 class="fs-28 font-w600 mb-0 text-right text-black">567</h2>
											<p class="mb-0 fs-14 font-w400 text-black">Prospect partners</p>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="card">
									<div class="card-header border-0 pb-0">
										<div class="mr-2">
											<h4 class="fs-20 mb-0 font-w500 text-black">Outstanding tasks/tickets</h4>
										</div>
									</div>
									<div class="card-body">
										<div class="border-bottom up-project-bx pb-4 mb-4">
											<span class="fs-16 text-primary mb-2 d-block sub-title font-w500">loprem plusam  </span>
											<div class="d-flex">
												<p class="font-w500 mr-auto mb-2 title fs-20"><a href="post-details.html" class="text-black">loprem plusam  doloe waht you</a></p>
											...
											<div class="mb-3"><i class="fa fa-calendar-o mr-3" aria-hidden="true"></i>loprem plusam  doloe waht you</div>
											<div class="media align-items-center">
												...
												<div class="media-body">
													...
													<span class="text-black font-w600">nov,  Sep 29th 2020</span>
												</div>
											</div>
										</div>
										<div class="border-bottom up-project-bx pb-4 mb-4">
											...
											<div class="d-flex">
												<p class="font-w500 mr-auto title mb-2 fs-20"><a href="post-details.html" class="text-black">loprem plusam  doloe waht you</a></p>
												<div class="dropdown mb-3">
													<a href="javascript:void(0)" data-toggle="dropdown" aria-expanded="false">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															<path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="#575757" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
									...
									<div class="card-body">
										<div class="sub-card bg-warning d-flex text-white">
											<div class="mr-auto pr-2">
												<h4 class="fs-20 mb-0 font-w600 text-white">Create task</h4>
										...
										<div class="sub-card">
											...
											<p class="font-w500"><a href="post-details.html" class="text-black">lorem plusam dolor you have</a></p>
											<div class="row justify-content-between align-items-center">
												<div class="col-6">
													<span>Aug 4, 2021</span>
												</div>
												<ul class="users col-6">
													<li><img src="dash-assets/images/profile/Untitled-4.jpg" alt=""></li>
													<li><img src="dash-assets/images/profile/Untitled-5.jpg" alt=""></li>
													<li><img src="dash-assets/images/profile/Untitled-5.jpg" alt=""></li>
													<li><img src="dash-assets/images/profile/Untitled-7.jpg" alt=""></li>
												</ul>
										...
										<div class="sub-card">
											...
											<div class="row justify-content-between align-items-center">
												...
												<ul class="users col-6">
													<li><img src="dash-assets/images/profile/Untitled-4.jpg" alt=""></li>
													<li><img src="dash-assets/images/profile/Untitled-5.jpg" alt=""></li>
													<li><img src="dash-assets/images/profile/Untitled-6.jpg" alt=""></li>
												</ul>
											</div>
										</div>
										<div class="sub-card">
