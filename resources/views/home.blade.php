		...
		<div class="card radius-10">
			<div class="card-body">
				<div class="d-flex align-items-center">
					<div>
						<p class="mb-0 text-secondary">lorem plusam</p>
			...
			<div class="product-list p-3 mb-3">
					...
					<div class="col-sm-6">
						<div class="d-flex align-items-center">
							<div class="product-img">
								<img src="dash-assets/images/icons/chair.png" alt="" />
							</div>
							<div class="ms-2">
								<h6 class="mb-1">light Blue </h6>
				...
				<div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
					<div class="col-sm-6">
						<div class="d-flex align-items-center">
							<div class="product-img">
								<img src="dash-assets/images/icons/user-interface.png" alt="" />
							</div>
							<div class="ms-2">
								<h6 class="mb-1"> lorem  7x</h6>
				...
				<div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
					<div class="col-sm-6">
						<div class="d-flex align-items-center">
							<div class="product-img">
								<img src="dash-assets/images/icons/watch.png" alt="" />
							</div>
							<div class="ms-2">
								<h6 class="mb-1">lorem </h6>
				...
				<div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
					<div class="col-sm-6">
						<div class="d-flex align-items-center">
							<div class="product-img">
								<img src="dash-assets/images/icons/idea.png" alt="" />
							</div>
							<div class="ms-2">
								<h6 class="mb-1">uder ect</h6>
				...
				<div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
					<div class="col-sm-6">
						<div class="d-flex align-items-center">
							<div class="product-img">
								<img src="dash-assets/images/icons/tshirt.png" alt="" />
							</div>
							<div class="ms-2">
								<h6 class="mb-1">prem-T-</h6>
				...
				<div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
					<div class="col-sm-6">
						<div class="d-flex align-items-center">
							<div class="product-img">
								<img src="dash-assets/images/icons/headphones.png" alt="" />
							</div>
							<div class="ms-2">
								<h6 class="mb-1">Smart </h6>
				...
				<div class="row border mx-0 py-2 radius-10 cursor-pointer">
					<div class="col-sm-6">
						<div class="d-flex align-items-center">
							<div class="product-img">
								<img src="dash-assets/images/icons/shoes.png" alt="" />
							</div>
							<div class="ms-2">
								<h6 class="mb-1">Greens orts </h6>
						...
						<tbody>
							<tr>
								<td>
									<div class="d-flex align-items-center">
										<div class="">
											<img src="dash-assets/images/avatars/avatar-1.png" class="rounded-circle" width="46" height="46" alt="" />
										</div>
										<div class="ms-2">
							...
							<tr>
								<td>
									<div class="d-flex align-items-center">
										<div class="">
											<img src="dash-assets/images/avatars/avatar-2.png" class="rounded-circle" width="46" height="46" alt="" />
										</div>
										<div class="ms-2">
							...
							<tr>
								<td>
									<div class="d-flex align-items-center">
										<div class="">
											<img src="dash-assets/images/avatars/avatar-3.png" class="rounded-circle" width="46" height="46" alt="" />
										</div>
										<div class="ms-2">
							...
							<tr>
								<td>
									<div class="d-flex align-items-center">
										<div class="">
											<img src="dash-assets/images/avatars/avatar-4.png" class="rounded-circle" width="46" height="46" alt="" />
										</div>
										<div class="ms-2">
							...
							<tr>
								<td>
									<div class="d-flex align-items-center">
										<div class="">
											<img src="dash-assets/images/avatars/avatar-7.png" class="rounded-circle" width="46" height="46" alt="" />
										</div>
										<div class="ms-2">
							...
							<tr>
								<td>
									<div class="d-flex align-items-center">
										<div class="">
											<img src="dash-assets/images/avatars/avatar-8.png" class="rounded-circle" width="46" height="46" alt="" />
										</div>
										<div class="ms-2">
							...
							<tr>
								<td>
									<div class="d-flex align-items-center">
										<div class="">
											<img src="dash-assets/images/avatars/avatar-9.png" class="rounded-circle" width="46" height="46" alt="" />
										</div>
										<div class="ms-2">
							...
							<tr>
								<td>
									<div class="d-flex align-items-center">
										<div class="">
											<img src="dash-assets/images/avatars/avatar-10.png" class="rounded-circle" width="46" height="46" alt="" />
										</div>
										<div class="ms-2">
							...
							<tr>
								<td>
									<div class="d-flex align-items-center">
										<div class="">
											<img src="dash-assets/images/avatars/avatar-11.png" class="rounded-circle" width="46" height="46" alt="" />
										</div>
										<div class="ms-2">
							...
							<tr>
								<td>
									<div class="d-flex align-items-center">
										<div class="">
											<img src="dash-assets/images/avatars/avatar-12.png" class="rounded-circle" width="46" height="46" alt="" />
										</div>
										<div class="ms-2">
											<h6 class="mb-1 font-14">Payment from Lewis Cruz</h6>
											<p class="mb-0 font-13 text-secondary">Refrence Id #8576420</p>
							...
							<tr>
								<td>
									<div class="d-flex align-items-center">
										<div class="">
											<img src="dash-assets/images/avatars/avatar-13.png" class="rounded-circle" width="46" height="46" alt="" />
										</div>
										<div class="ms-2">
											<h6 class="mb-1 font-14">Payment from David Buckley</h6>
											<p class="mb-0 font-13 text-secondary">Refrence Id #8576420</p>
							...
							<tr>
								<td>
									<div class="d-flex align-items-center">
										<div class="">
											<img src="dash-assets/images/avatars/avatar-14.png" class="rounded-circle" width="46" height="46" alt="" />
										</div>
										<div class="ms-2">
