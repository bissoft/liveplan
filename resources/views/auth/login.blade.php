...
<head>
    ...
    <!--favicon-->
    <!-- <link rel="icon" href="dash-assets/images/favicon-32x32.png" type="image/png" /> -->
    <!-- loader-->
                ...
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                    <div class="col mx-auto">
                        <div class="mb-4 text-center">
                            <img src="assets/img/logo.svg')}}" width="180" alt="" />
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                        ...
                                        <form action="{{ route('login') }}" method="POST" class="row g-3">
                                            ...
                                            <div class="col-12">
                                                <label for="inputEmailAddress" class="form-label">Email
                                                    Address</label>
                                                <input type="email" name="email" class="form-control" value="{{old('email')}}" id="inputEmailAddress"
                                            ...
                                            <div class="col-md-6 text-end"> <a
                                                    href="{{ route('recover.password') }}">Forgot Password ?</a>
                                            </div>
                                            <div class="col-12">
                                                <div class="d-grid">
                                    ...
                                    <div class="d-grid">
                                        <a class="btn my-4 shadow-sm btn-white" href="javascript:;"> <span
                                                ...
                                                <img class="me-2"
                                                    src="{{ asset('dash-assets/images/icons/search.svg') }}" width="16"
...
<!-- Mirrored from creatantech.com/demos/codervent/syndron/vertical/public/authentication-signin by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Apr 2022 08:09:36 GMT -->
