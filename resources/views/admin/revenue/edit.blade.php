                ...
                <div class="mt-4">
                    <div class="wizard">
                        ...
                        <form role="form" id="quickForm"
                            action="{{ route('admin.revenue.update', $revenue->id) }}" method="post"
                            ...
                            <div class="tab-content" id="main_form">
                                    ...
                                    id="step1">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="mb-2">What do you
                                                want
                                                to call it?</label>
                                            <input type="text" name="name" value="{{ $revenue->name ?? '' }}"
                                ...
                                <div class="tab-pane" role="tabpanel"
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" name="type"
                                            onclick="Type1()" value="1"
                                            @if ($revenue->type == 1) checked @endif>
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" name="type"
                                            onclick="Type2()" value="2"
                                            @if ($revenue->type == 2) checked @endif>
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" name="type"
                                            onclick="Type3()" value="3"
                                            @if ($revenue->type == 3) checked @endif>
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" name="type"
                                            onclick="Type4()" value="4"
                                            @if ($revenue->type == 4) checked @endif>
                                ...
                                <div class="tab-pane" role="tabpanel"
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" checked name="unit_sell"
                                            ...
                                            @if ($revenue->unit_sell == 0) checked @endif>
                                        <label class="form-check-label" for="inlineRadio1">Constant
                                            amount</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio"
                                            onclick="step1_varying()" name="unit_sell"
                                            value="1" @if ($revenue->unit_sell == 1) checked @endif>
                                        ...
                                        <div class="row align-items-center mt-3">
                                            <div class="col-12 col-md-6 ">
                                                ...
                                                <input class="form-control" type="number"
                                                    ...
                                                    @if ($revenue->unit_sell == 0) value="{{ $revenue->unit_sell_amount ?? '' }}" @endif
                                                    placeholder="$">
                                            </div>
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    <select class="form-control" name="unit_constant_type"
                                                        ...
                                                        <option value="0"
                                                            @if ($revenue->unit_constant_type == 0) checked @endif>
                                                            Month</option>
                                                        <option value="1"
                                                            @if ($revenue->unit_constant_type == 1) checked @endif>
                                                            Year</option>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="varning-amount mt-3"
                                        ...
                                        <canvas id="unit_month_chart"
                                            style="max-height:350px;"></canvas>
                                        <div class="cahrt-value">
                                            @php
                                                $unit_sell_amount = json_decode($revenue->unit_sell_amount,true);
                                            @endphp
                                            @for ($i = 0; $i < 12; $i++)
                                                <div class="input-filed">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        name="unit_month{{ $i }}"
                                                        id="unit_month{{ $i }}"
                                                        @if ($revenue->unit_sell == 1) value="{{$unit_sell_amount[$i]??'' }}" @endif>
                                                </div>
                                            @endfor
                                            <div class="input-filed">
                                                <label for="">Total</label>
                                                <input type="number" class="form-control"
                                                    name="unit_month_total" id="unit_month_total"
                                                    @if ($revenue->unit_sell == 1) value="{{ $unit_sell_amount[12] ?? '' }}" @endif>
                                            </div>
                                        </div>
                                        <div class="cahrt-value">
                                            @for ($i = 2; $i < 6; $i++)
                                                <div class="input-filed">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        name="unit_year{{ $i }}"
                                                        @if ($revenue->unit_sell == 1) value="{{ $unit_sell_amount[11 + $i] ?? '' }}" @endif>
                                                </div>
                                            @endfor
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" role="tabpanel"
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="unit_price"
                                            ...
                                            @if ($revenue->unit_price == 0) checked @endif
                                            onclick="step2_constant()">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="unit_price"
                                            ...
                                            @if ($revenue->unit_price == 1) checked @endif
                                            onclick="step2_varying()">
                                    ...
                                    <div id="step2_constant">
                                        <div class="col-12 col-md-6 mt-3 position-relative">
                                            <input class="form-control  pl-2" placeholder="$" type="number"
                                                ...
                                                @if ($revenue->unit_price == 0) value="{{ $revenue->unit_price_amount ?? '' }}" @endif>
                                    ...
                                    <div class="varning-amount mt-3" id="step2_varying">
                                        <h4>FY{{ Carbon::now()->format('Y') ?? '' }}</h4>
                                        <canvas id="sale_month_chart"
                                            style="max-height:350px;"></canvas>
                                        <div class="cahrt-value">
                                            @php
                                                $unit_price_amount = json_decode($revenue->unit_price_amount,true);
                                            @endphp
                                            @for ($i = 0; $i < 12; $i++)
                                                <div class="input-filed">
                                                    <label
                                                        for="">{{ Carbon::now()->addMonth($i)->format('M Y') }}</label>
                                                    <input type="number" class="form-control"
                                                        name="sale_month{{ $i }}" id="sale_month{{$i}}"
                                                        @if ($revenue->unit_price == 1) value="{{ $unit_price_amount[$i] ?? '' }}" @endif>
                                                </div>
                                            @endfor
                                        </div>
                                        <div class="cahrt-value">
                                            @for ($i = 1; $i < 6; $i++)
                                                <div class="input-filed">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        name="sale_year{{ $i }}"
                                                        @if ($revenue->unit_price == 1) value="{{ $unit_price_amount[11 + $i] ?? '' }}" @endif>
                                                </div>
                                            @endfor
                                ...
                                <div class="tab-pane" role="tabpanel"
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="bill_for"
                                            ...
                                            @if ($revenue->bill_for == 0) checked @endif
                                            onclick="step5_constant()">
                                        <label class="form-check-label" for="inlineRadio1">Constant
                                            amount</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="bill_for"
                                            ...
                                            @if ($revenue->bill_for == 1) checked @endif
                                            onclick="step5_varying()">
                                        <label class="form-check-label" for="inlineRadio2">Varying amounts over
                                            time</label>
                                    </div>
                                        ...
                                        <div class="row align-items-center mt-3">
                                            <div class="col-12 col-md-6 ">
                                                <input class="form-control" type="number" placeholder="$"
                                                    name="bill_amount"
                                                    @if ($revenue->bill_for == 0) value="{{ $revenue->bill_amount ?? '' }}" @endif>
                                            </div>
                                            <div class="col-12 col-md-2 text-center">Per</div>
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    <select class="form-control"
                                                        ...
                                                        id="exampleFormControlSelect1">
                                                        <option value="0"
                                                            @if ($revenue->bill_constant_type == 0) selected @endif>
                                                            Month</option>
                                                        <option value="1"
                                                            @if ($revenue->bill_constant_type == 1) selected @endif>
                                                            Year</option>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="varning-amount mt-3" id="step5_varying">
                                        ...
                                        <div class="cahrt-value">
                                            @php
                                                $bill_amount = json_decode($revenue->bill_amount,true);
                                            @endphp
                                            @for ($i = 0; $i < 12; $i++)
                                                <div class="input-filed">
                                                    <label
                                                    ...
                                                    <input type="number" class="form-control"
                                                        ...
                                                        @if ($revenue->bill_for == 1) value="{{ $bill_amount[$i] ?? '' }}" @endif
                                                        id="billable_month{{ $i }}">
                                                </div>
                                            @endfor
                                            <div class="input-filed">
                                                <label for="">Total</label>
                                                <input type="number" class="form-control"
                                                    name="billable_month_total"
                                                    id="billable_month_total"
                                                    @if ($revenue->bill_for == 1) value="{{ $bill_amount[12] ?? '' }}" @endif>
                                            </div>
                                        </div>
                                        <div class="cahrt-value">
                                            @for ($i = 2; $i < 6; $i++)
                                                <div class="input-filed">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        ...
                                                        @if ($revenue->bill_for == 1) value="{{ $bill_amount[11 + $i] ?? '' }}" @endif>
                                                </div>
                                            @endfor
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" role="tabpanel"
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio"
                                            ...
                                            @if ($revenue->bill_hour == 0) checked @endif
                                            onclick="step6_constant()">
                                        <label class="form-check-label" for="inlineRadio11">Constant
                                            amount</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio"
                                            ...
                                            @if ($revenue->bill_hour == 1) checked @endif
                                            onclick="step6_varying()">
                                        <label class="form-check-label" for="inlineRadio21">Varying amounts
                                            over
                                            time</label>
                                    </div>
                                    <div id="step6_constant">
                                        <div class="col-12 col-md-6 mt-3 position-relative">
                                            <input class="form-control  pl-2" type="number" placeholder="$"
                                                ...
                                                @if($revenue->bill_hour==0) value="{{ $revenue->bill_hour_amount ?? '' }}" @endif>
                                            <i class="fa fa-dollar-sign"
                                                style="position: absolute;top: 12px;left: 3px;"></i>
                                        </div>
                                    </div>
                                    ...
                                    <div class="varning-amount mt-3" id="step6_varying">
                                        <h4>FY{{ Carbon::now()->format('Y') ?? '' }}</h4>
                                        <canvas id="rate_month_chart"
                                            style="max-height:350px;"></canvas>
                                        <div class="cahrt-value">
                                            @php
                                                $bill_hour_amount = json_decode($revenue->bill_hour_amount,true);
                                            @endphp
                                            @for ($i = 0; $i < 12; $i++)
                                                <div class="input-filed">
                                                    <label
                                                        for="">{{ Carbon::now()->addMonth($i)->format('M Y') }}</label>
                                                    <input type="number" class="form-control"
                                                        name="rate_month{{ $i }}" id="rate_month{{$i}}"
                                                        @if ($revenue->bill_hour == 1) value="{{ $bill_hour_amount[$i] ?? '' }}" @endif>
                                                </div>
                                            @endfor
                                        </div>
                                        <div class="cahrt-value">
                                            @for ($i = 1; $i < 6; $i++)
                                                <div class="input-filed">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        name="rate_year{{ $i }}"
                                                        @if ($revenue->bill_hour == 1) value="{{ $bill_hour_amount[11 + $i] ?? '' }}" @endif>
                                                </div>
                                            @endfor
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" role="tabpanel"
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                @if ($revenue->signups == 0) checked @endif
                                                name="signups" value="0"
                                                onclick="step7_constant()">
                                            <label class="form-check-label" for="inlineRadio1">Constant
                                                amount</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                onclick="step7_varying()" name="signups"
                                                @if ($revenue->signups == 1) checked @endif value="1">
                                    ...
                                    <div id="step7_constant">
                                        <div class="row align-items-center mt-3">
                                            <div class="col-12 col-md-6 ">
                                             ...
                                             placeholder="$" @if ($revenue->signups == 0) value="{{ $revenue->signups_amount ?? '' }}" @endif>
                                            </div>
                                    ...
                                    <div class="varning-amount mt-3" id="step7_varying">
                                        <h4>FY{{ Carbon::now()->format('Y') }}</h4>
                                        <canvas id="signup_month_chart"
                                            style="max-height:350px;"></canvas>
                                        <div class="cahrt-value">
                                            @php
                                                $signups_amount = json_decode($revenue->signups_amount,true);
                                            @endphp
                                            @for ($i = 0; $i < 12; $i++)
                                                <div class="input-filed">
                                                    <label
                                                    ...
                                                    <input type="number" class="form-control"
                                                        name="signup_month{{ $i }}"
                                                        id="signup_month{{ $i }}"
                                                        @if ($revenue->signups == 1) value="{{ $signups_amount[$i] ?? '' }}" @endif>
                                                </div>
                                            @endfor
                                            <div class="input-filed">
                                                <label for="">Total</label>
                                                <input type="number" class="form-control"
                                                    ...
                                                    @if ($revenue->signups == 1) value="{{ $signups_amount[12] ?? '' }}" @endif>
                                            </div>
                                        </div>
                                        <div class="cahrt-value">
                                            @for ($i = 2; $i < 6; $i++)
                                                <div class="input-filed">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        name="signup_year{{ $i }}"
                                                        @if ($revenue->signups == 1) value="{{ $signups_amount[11 + $i] ?? '' }}" @endif>
                                                </div>
                                            @endfor
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" role="tabpanel"
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    @if ($revenue->up_front == 2) checked @endif
                                                    onclick="step8_nofee()">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    @if ($revenue->up_front == 0) checked @endif
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    @if ($revenue->up_front == 1) checked @endif
                                                    onclick="step8_varying()"
                                        ...
                                        <div class="row align-items-center mt-3">
                                            <div class="col-12 col-md-6 ">
                                                <input class="form-control" type="text"
                                                    ...
                                                    @if ($revenue->up_front==0) value="{{ $revenue->up_front_amount ?? '' }}" @endif
                                                    placeholder="$">
                                            </div>
                                    ...
                                    <div class="varning-amount mt-3" id="step8_varying">
                                        <h4>FY{{ Carbon::now()->format('Y') }}</h4>
                                        <canvas id="up_front_month_chart"
                                            style="max-height:350px;"></canvas>
                                        <div class="cahrt-value">
                                            @php
                                                $up_front_amount = json_decode($revenue->up_front_amount,true);
                                            @endphp
                                            @for ($i = 0; $i < 12; $i++)
                                                <div class="input-filed">
                                                    <label
                                                        for="">{{ Carbon::now()->addMonth($i)->format('M Y') }}</label>
                                                    <input type="number" class="form-control"
                                                        name="up_front_month{{ $i }}" id="up_front_month{{$i}}"
                                                        @if ($revenue->up_front == 1) value="{{ $up_front_amount[$i] ?? '' }}" @endif>
                                                </div>
                                            @endfor
                                        </div>
                                        <div class="cahrt-value">
                                            @for ($i = 1; $i < 6; $i++)
                                                <div class="input-filed">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        ...
                                                        @if ($revenue->up_front == 1) value="{{ $up_front_amount[11 + $i] ?? '' }}" @endif>
                                                </div>
                                            @endfor
                                        </div>
                                    </div>
                                    <div class="form-group mt-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                ...
                                                @if ($revenue->recurring_charge == 0) checked @endif
                                                onclick="step8_2_constant()">
                                            <label class="form-check-label" for="inlineRadio1">Constant
                                                amount</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                onclick="step8_2_varying()"
                                                @if ($revenue->recurring_charge == 1) checked @endif
                                        ...
                                        <div class="row align-items-center mt-3">
                                            <div class="col-12 col-md-6 ">
                                                <input class="form-control" type="text"
                                                    ...
                                                    @if ($revenue->recurring_charge == 0) value="{{ $revenue->recurring_amount ?? '' }}" @endif>
                                            </div>
                                            <div class="col-12 col-md-2 text-center">Per Month</div>
                                        </div>
                                    </div>
                                    <div class="varning-amount mt-3" id="step8_2_varying">
                                        <h4>FY{{ Carbon::now()->format('Y') }}</h4>
                                        <canvas id="recurring_month_chart"
                                            style="max-height:350px;"></canvas>
                                        <div class="cahrt-value">
                                            @php
                                                $recurring_amount = json_decode($revenue->recurring_amount,true);
                                            @endphp
                                            @for ($i = 0; $i < 12; $i++)
                                                <div class="input-filed">
                                                    <label
                                                        for="">{{ Carbon::now()->addMonth($i)->format('M Y') }}</label>
                                                    <input type="number" class="form-control"
                                                        name="recurring_month{{ $i }}" id="recurring_month{{$i}}"
                                                        @if ($revenue->recurring_charge == 1) value="{{ $recurring_amount[$i] ?? '' }}" @endif>
                                                </div>
                                            @endfor
                                        </div>
                                        <div class="cahrt-value">
                                            @for ($i = 1; $i < 6; $i++)
                                                <div class="input-filed">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        ...
                                                        @if ($revenue->recurring_charge == 1) value="{{ $recurring_amount[11 + $i] ?? '' }}" @endif>
                                                </div>
                                            @endfor
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" role="tabpanel"
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                @if ($revenue->churn_rate == 0) checked @endif
                                                name="churn_rate" value="0"
                                                onclick="step9_constant()">
                                            <label class="form-check-label" for="inlineRadio1">Constant
                                                amount</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                onclick="step9_varying()"
                                                @if ($revenue->churn_rate == 1) checked @endif
                                    ...
                                    <div id="step9_constant">
                                        <div class="row align-items-center mt-3">
                                            <div class="col-12 col-md-6 ">
                                                ...
                                                @if ($revenue->churn_rate == 0) value="{{ $revenue->churn_amount ?? '' }}" @endif
                                                    placeholder="$">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="varning-amount mt-3" id="step9_varying">
                                        <h4>FY{{ Carbon::now()->format('Y') }}</h4>
                                        <canvas id="churn_month_chart"
                                            style="max-height:350px;"></canvas>
                                        <div class="cahrt-value">
                                            @php
                                                $churn_amount = json_decode($revenue->churn_amount,true);
                                            @endphp
                                            @for ($i = 0; $i < 12; $i++)
                                                <div class="input-filed">
                                                    <label
                                                        for="">{{ Carbon::now()->addMonth($i)->format('M Y') }}</label>
                                                    <input type="number" class="form-control"
                                                        name="churn_month{{ $i }}" id="churn_month{{$i}}"
                                                        @if ($revenue->churn_rate == 1) value="{{ $churn_amount[$i] }}" @endif>
                                                </div>
                                            @endfor
                                        </div>
                                        <div class="cahrt-value">
                                            @for ($i = 1; $i < 6; $i++)
                                                <div class="input-filed">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        name="churn_year{{ $i }}"
                                                        @if ($revenue->churn_rate == 1) value="{{ $churn_amount[11 + $i] }}" @endif>
                                                </div>
                                            @endfor
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" role="tabpanel"
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="only_revenue"
                                            @if ($revenue->only_revenue == 0) checked @endif id="inlineRadio1"
                                            value="0" onclick="step10_constant()">
                                        <label class="form-check-label" for="inlineRadio1">Constant
                                            amount</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="only_revenue"
                                            @if ($revenue->only_revenue == 1) checked @endif id="inlineRadio2"
                                    ...
                                    <div id="step10_constant">
                                        <div class="row align-items-center mt-3">
                                            <div class="col-12 col-md-6 ">
                                                <input class="form-control" type="number" placeholder="$" name="only_revenue_amount"
                                                 @if($revenue->only_revenue==0) value="{{ $revenue->only_revenue_amount ?? '' }}" @endif>
                                            </div>
                                            <div class="col-12 col-md-2 text-center">Per</div>
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    <select class="form-control" name="revenue_constant_type"
                                                        id="exampleFormControlSelect1">
                                                        <option value="0"
                                                            @if ($revenue->only_revenue_type == 0) selected @endif>
                                                            Month</option>
                                                        <option value="1"
                                                            @if ($revenue->only_revenue_type == 1) selected @endif>
                                                            Year</option>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="varning-amount mt-3" id="step10_varying">
                                        <h4>FY{{ Carbon::now()->format('Y') }}</h4>
                                        <canvas id="revenue_month_chart"
                                            style="max-height:350px;"></canvas>
                                        <div class="cahrt-value">
                                            @php
                                                $only_revenue_amount = json_decode($revenue->only_revenue_amount,true);
                                            @endphp
                                            @for ($i = 0; $i < 12; $i++)
                                                <div class="input-filed">
                                                    <label
                                                    ...
                                                    <input type="number" class="form-control"
                                                        ...
                                                        id="revenue_month{{ $i }}"
                                                        @if ($revenue->only_revenue == 1) value="{{ $only_revenue_amount[$i] }}" @endif>
                                                </div>
                                            @endfor
                                            <div class="input-filed">
                                                <label for="">Total</label>
                                                <input type="number" class="form-control"
                                                    name="revenue_month_total"
                                                    id="revenue_month_total"
                                                    @if ($revenue->only_revenue == 1) value="{{ $only_revenue_amount[12] }}" @endif>
                                            </div>
                                        </div>
                                        <div class="cahrt-value">
                                            @for ($i = 2; $i < 6; $i++)
                                                <div class="input-filed">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        name="revenue_year{{ $i }}"
                                                        @if ($revenue->only_revenue == 1) value="{{ $only_revenue_amount[11 + $i] }}" @endif>
                                                </div>
                                            @endfor
                                        </div>
                                    </div>
