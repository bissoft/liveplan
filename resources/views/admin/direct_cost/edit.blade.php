            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-header page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Update Direct Cost</h4>
                    </div>
                </div>
            </div>
            @if (session('error'))
                    ...
                    <div class="mt-4">
                        <div class="wizard">
                            <form role="form" id="quickForm"
                                action="{{ route('admin.direct-cost.update', $direct_cost->id) }}" method="post"
                                    ...
                                    <div class="tab-pane active" role="tabpanel" id="step1">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="mb-2">What do you want to call
                                                it?</label>
                                            <input type="text" name="name" value="{{ $direct_cost->name ?? '' }}"
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                @if ($direct_cost->cost == 0) checked @endif name="cost" value="0"
                                                onclick="Cost()">
                                            <label class="form-check-label" for="inlineRadio1">General Cost</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                @if ($direct_cost->cost == 1) checked @endif onclick="Cost1()"
                                                name="cost" value="1">
                                            ...
                                            <select name="revenue_id" class="form-control" id="">
                                                @foreach ($revenue as $item)
                                                    <option value="{{ $item->id ?? '' }}"
                                                        @if ($direct_cost->revenue_id == $item->id) selected @endif>
                                                        {{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="mt-3" id="general_cost_tab">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" checked name="constant" value="0"
                                                onclick="step1_constant()" @if ($direct_cost->constant == 0) checked @endif>
                                            <label class="form-check-label" for="inlineRadio1">Constant
                                                amount</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" onclick="step1_varying()"
                                                name="constant" value="1" @if ($direct_cost->constant == 1) checked @endif>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" onclick="step1_overall()"
                                                name="constant" value="2" @if ($direct_cost->constant == 2) checked @endif>
                                            ...
                                            <div class="row align-items-center mt-3">
                                                <div class="col-12 col-md-6 ">
                                                    <input class="form-control" type="number" name="cost_amount"
                                                        @if ($direct_cost->constant == 0) value="{{ $direct_cost->cost_amount ?? '' }}" @endif
                                                        placeholder="$">
                                                </div>
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <div class="form-group">
                                                        <select class="form-control" name="cost_amount_type"
                                                            ...
                                                            <option value="0"
                                                                @if ($direct_cost->cost_amount_type == 0) selected @endif>Month
                                                            </option>
                                                            <option value="1"
                                                                @if ($direct_cost->cost_amount_type == 1) selected @endif>Year
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="varning-amount mt-3" id="step1_varying">
                                            ...
                                            <div class="cahrt-value">
                                                @php
                                                    $cost_amount = json_decode($direct_cost->cost_amount, true);
                                                @endphp
                                                @for ($i = 0; $i < 12; $i++)
                                                    <div class="input-filed">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            name="cost_month{{ $i }}"
                                                            id="cost_month{{ $i }}"
                                                            @if ($direct_cost->constant == 1) value="{{ $cost_amount[$i] ?? '' }}" @endif>
                                                    </div>
                                                @endfor
                                                <div class="input-filed">
                                                    ...
                                                    <input type="number" class="form-control" name="cost_month_total"
                                                        id="cost_month_total"
                                                        @if ($direct_cost->constant == 1) value="{{ $cost_amount[12] ?? '' }}" @endif>
                                                </div>
                                            </div>
                                            <div class="cahrt-value">
                                                @for ($i = 2; $i < 6; $i++)
                                                    <div class="input-filed">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            name="cost_year{{ $i }}"
                                                            @if ($direct_cost->constant == 1) value="{{ $cost_amount[11 + $i] ?? '' }}" @endif>
                                                    </div>
                                                @endfor
                                            </div>
                                        </div>
                                            ...
                                            <div class="row align-items-center mt-3">
                                                <div class="col-12 col-md-6 ">
                                                    ...
                                                    <input class="form-control" type="number"
                                                        ...
                                                        @if ($direct_cost->constant == 3) value="{{ $item->cost_amount ?? '' }}" @endif
                                                        placeholder="%">
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <label for="exampleFormControlSelect1"><b>When will it
