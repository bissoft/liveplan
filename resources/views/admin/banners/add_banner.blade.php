...
<div class="container">
            <div class="row">
              <div class="col-md-12">
                <form role="form" id="quickForm" action="{{url('/banner/store')}}" method="post" enctype="multipart/form-data">
                  @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Title</label>
                    <input type="text" name="title" class="form-control" id="name" placeholder="Enter Banner Title">
                  </div>
                  {{-- <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="banner_desc" class="form-control" id="banner_desc" placeholder="Enter Banner Description">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">String type 1</label>
                      <input type="text" name="string1" class="form-control" id="banner_desc" placeholder="Enter string type one">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">String type 2</label>
                      <input type="text" name="string2" class="form-control" id="banner_desc" placeholder="Enter string type one">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">String type 3</label>
                      <input type="text" name="string3" class="form-control" id="banner_desc" placeholder="Enter string type one">
                    </div>
                    <div class="form-group">
