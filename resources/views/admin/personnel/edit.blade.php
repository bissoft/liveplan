        ...
        <div class="card">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-header page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Update Personnel</h4>
                    </div>
                </div>
            </div>
            @if (session('error'))
            ...
            <div class="card-body">
                <div class="revanu">
                    <div class="mt-4">
                        <div class="wizard">
                            <form role="form" id="quickForm" action="{{ route('admin.personnel.update',$personnel->id) }}" method="post"
                                ...
                                <div class="tab-content" id="main_form">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"  @if($personnel->employee_type==0) checked @endif name="employee_type" value="0"
                                                onclick="Employee_type1()">
                                            <label class="form-check-label" for="inlineRadio1">Individual
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" onclick="Employee_type2()"  @if($personnel->employee_type==1) checked @endif name="employee_type"
                                                value="1">
                                    ...
                                    <div class="mt-3" id="group_employee_tab">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"  @if($personnel->group_constant==0) checked @endif name="group_constant" value="0"
                                                onclick="step1_constant()">
                                            <label class="form-check-label" for="inlineRadio1">Constant
                                                numbers</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" @if($personnel->group_constant==1) checked @endif onclick="step1_varying()"
                                        ...
                                        <div id="step1_constant">
                                            <div class="row align-items-center mt-3">
                                                <div class="col-12 col-md-6 ">
                                                    ...
                                                    @if ($personnel->group_constant == 0) value="{{ $personnel->group_employee??'' }}" @endif placeholder="$">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="varning-amount mt-3" id="step1_varying">
                                            ...
                                            <div class="cahrt-value">
                                                @php
                                                    $group_employee = json_decode($personnel->group_employee, true);
                                                @endphp
                                                @for ($i = 0; $i < 12; $i++)
                                                    <div class="input-filed">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            name="group_month{{ $i }}"
                                                            id="group_month{{ $i }}"  @if ($personnel->group_constant == 1) value="{{$group_employee[$i]??''}}" @endif>
                                                    </div>
                                                @endfor
                                                <div class="input-filed">
                                                    <label for="">Total</label>
                                                    <input type="number" class="form-control" name="group_month_total"
                                                        id="group_month_total"  @if ($personnel->group_constant == 1) value="{{$group_employee[12]??''}}" @endif>
                                                </div>
                                            </div>
                                            <div class="cahrt-value">
                                                @for ($i = 2; $i < 6; $i++)
                                                    <div class="input-filed">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            name="group_year{{ $i }}"  @if ($personnel->group_constant == 1) value="{{$group_employee[11+$i]??''}}" @endif>
                                                    </div>
                                                @endfor
                                            </div>
                                        </div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="labor_type" value="0" @if ($personnel->labor_type == 0) checked @endif>
                                            <label class="form-check-label" for="inlineRadio1">Regular labor
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="labor_type"
                                                value="1"  @if ($personnel->labor_type == 1) checked @endif>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" onclick="Constant1()"  @if ($personnel->constant == 0) checked @endif name="constant" value="0">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"  onclick="Constant2()" name="constant"
                                                value="1"  @if ($personnel->constant == 1) checked @endif>
                                        ...
                                        <div class="row align-items-center mt-3">
                                            <div class="col-12 col-md-6 ">
                                                <input class="form-control" type="number" name="constant_amount"
                                                   @if($personnel->constant==0) value="{{ $personnel->constant_amount??'' }}" @endif placeholder="$">
                                            </div>
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    <select class="form-control" name="constant_amount_type"
                                                        ...
                                                        <option value="0" @if($personnel->constant_amount_type==0) selected @endif>Month</option>
                                                        <option value="1" @if($personnel->constant_amount_type==1) selected @endif>Year</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-2 col-md-4">
                                                <input type="number" name="annual" value="{{$personnel->annual??''}}" class="form-control" placeholder="%">
                                            </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="varning-amount mt-3" id="varying_amount_tab">
                                        ...
                                        <div class="cahrt-value">
                                                @php
                                                    $constant_amount = json_decode($personnel->constant_amount, true);
                                                @endphp
                                            @for ($i = 0; $i < 12; $i++)
                                                <div class="input-filed">
                                                    <label
                                                    ...
                                                    <input type="number" class="form-control"
                                                        ...
                                                        id="constant_month{{ $i }}" @if ($personnel->constant == 1) value="{{ $constant_amount[$i] ?? '' }}" @endif>
                                                </div>
                                            @endfor
                                            <div class="input-filed">
                                                <label for="">Total</label>
                                                <input type="number" class="form-control" name="constant_month_total"
                                                    id="constant_month_total" @if ($personnel->constant == 1) value="{{ $constant_amount[12] ?? '' }}" @endif >
                                            </div>
                                        </div>
                                        <div class="cahrt-value">
                                            @for ($i = 2; $i < 6; $i++)
                                                <div class="input-filed">
                                                    <label
                                                        for="">FY{{ Carbon::now()->addYear($i)->format('Y') }}</label>
                                                    <input type="number" class="form-control"
                                                        name="constant_year{{ $i }}" @if ($personnel->constant == 1) value="{{ $constant_amount[11+$i] ?? '' }}" @endif>
                                                </div>
                                            @endfor
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" @if($personnel->employee_role==0) checked @endif name="employee_role" value="0">
                                            <label class="form-check-label" for="inlineRadio1">On-staff employees
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" @if($personnel->employee_role==1) checked @endif name="employee_role"
                                                value="1">
