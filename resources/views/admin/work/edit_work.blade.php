...
<div class="main-content">
             <div class="container">
              <div class="row">
                <div class="col-md-12">
                  <form role="form" id="quickForm" action="{{url('/work/update/'.$work->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                  <div class="card-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Title</label>
                      <input type="text" name="title" value="{{$work->title}}" class="form-control" id="name" placeholder="Enter Title">
                    </div>

                      <div class="form-group">
                        <label for="exampleInputEmail1">Description</label>
                        <input type="text" name="work_desc" value="{{$work->description}}" class="form-control" id="service_desc" placeholder="Enter  Description">
                      </div>
                      <div class="form-group">
                        <label for="image">Image</label>
                        <input type="file" name="image" class="form-control" id="image">
                        <input type="hidden" name="current_image"  value="{{$work->image}}">
                        <img src="{{asset('uploads/banners/'.$work->image)}}" alt="" style="height: 100px; width: 100px;">
                      </div>
                  </div>
                  <!-- /.card-body -->
