                        ...
                        <div class="col-12 col-md-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="heading" class="form-control"
                                    value="{{ $package->heading ?? old('heading') }}" id="heading" required
                        ...
                        <div class="col-12 col-md-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="price" class="form-control"
                                    value="{{ $package->price ?? old('price') }}" id="price" required
                        ...
                        <div class="col-12 col-md-6 mt-3">
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control" id="">
                                    <option value="0" @if($package->type==0) selected @endif>Monthly</option>
                                    <option value="1" @if($package->type==1) selected @endif>Yearly</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="point[]" class="form-control" multiple id="">
                                    @foreach ($packagePoint as $item)
                                        <option value="{{ $item->point }}"
                                            @if (in_array($item->point, $arr)) selected @endif>
                                            {{ $item->point }}</option>
                                    @endforeach
                                </select>
